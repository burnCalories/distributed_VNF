import gym
from ray.rllib.examples.env.multi_agent import MultiAgentEnv
...
# class SprEnv(MultiAgentEnv):
    ...
    def __init__(self,  **kwargs):
        ...
        self.action_space = gym.spaces.Discrete(self.params.action_limit)
        # Upper bound for the obs here is 1000, I assume TTL no higher than 1000
        self.observation_space = gym.spaces.Box(-20, 1000, shape=self.params.observation_shape)
    ...
    #     obs_space = gym.spaces.Tuple([gym.spaces.Dict({
